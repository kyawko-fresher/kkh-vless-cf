...
let userID = 'b0286bc2-e17c-4c17-b0e6-d39c93f74937';
...
function getวเลสConfig(userIDs, hostName) {
	const commonUrlPart = `:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#🙋🏻 ҠҠǶ_V2Rαყ 💗`;
	const hashSeparator = "###############";
	...
	const output = userIDArray.map((userID) => {
		...
		return `<h1>ҠҠǶ_V2Rαყ<span style="font-size: smaller;"> 🙋🏻Vless</span>💗</h1>\n
${วเลสMain}

<button onclick='copyToClipboard("${วเลสMain}")'><i class="fa fa-clipboard"></i> ကော်ပီကူးမည်</button>`;
	}).join('\n');
	...
	const header = `
<p align='center'><img src='https://cdn.pixabay.com/animation/2022/08/29/18/04/18-04-16-298_256.gif' alt='图片描述' style='margin-bottom: -50px;'>
`;
  ...
  <head>
	...
	<meta name='description' content='This is a tool for generating free vless config'>
	...
	<meta name='twitter:title' content='EDtunnel' />
          ...
          <div class="form-container">
                ...
                <form id="loginForm">
                    ...
                    <div class="form-control">
                        <p>iOS များအတွက် V2Box VPN တွင် ထည့်သွင်းအသုံးပြုပါက ပိုမိုကောင်းမွန်မြန်ဆန်ပါသည်</p>
                        <button type="reset" onclick="window.open('https://apps.apple.com/us/app/v2box-v2ray-client/id6446814690')" class="button">V2Box - V2ray Client VPN ကို‌ဒေါင်းလုတ်လုပ်မည်</button>
                        
                    </div>
                    <h2>Android</h2>
                    <div class="form-control">
                        <p>Android များအတွက် V2Box VPN တွင် ထည့်သွင်းအသုံးပြုပါက ပိုမိုကောင်းမွန်မြန်ဆန်ပါသည်</p>
                        <button type="reset" onclick="window.open('https://play.google.com/store/apps/details?id=dev.hexasoftware.v2box')" class="button">V2Box VPN ကို‌ဒေါင်းလုတ်လုပ်မည်</button>
                    </div>
  ...
  function copyToClipboard(text) {
    navigator.clipboard.writeText(text)
      .then(() => {
        alert("ဖော်ပြပါ vless အကောင့်အား ကော်ပီကူးယူပါမည်");
      })
      .catch((err) => {
